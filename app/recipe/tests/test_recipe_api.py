...
class PrivateRecipeAPITests(TestCase):
    ...
    def test_update_user_returns_error(self):
        """test trying to update user on recipe returns error"""
        other_user = create_user(
    ...
    def test_delete_other_user_recipe_error(self):
        """Test that deleting aother users recipe results in error"""
        other_user = create_user(
            email="test2@example.com",
            password="testpass123",
        )
    ...
    def test_create_recipe_with_new_tags(self):
        """Teste creating a receipewith new tags"""
        payload = {
            "title": "Test",
            "time_minutes": 30,
            "price": Decimal("2.50"),
    ...
    def test_create_tag_on_update(self):
        """Testcreating a tag when updating a receipe"""
        recipe = create_recipe(user=self.user)
    ...
    def test_filter_by_tags(self):
        ...
        r1 = create_recipe(user=self.user, title="receita1")
        r2 = create_recipe(user=self.user, title="receita2")
        tag1 = Tag.objects.create(user=self.user, name="Tag1")
        tag2 = Tag.objects.create(user=self.user, name="Tag2")
        r1.tags.add(tag1)
        r2.tags.add(tag2)
        r3 = create_recipe(user=self.user, title="receita3")
