    ...
    list=extend_schema(
        parameters=[
            OpenApiParameter(
                "tags",
                OpenApiTypes.STR,
                description="Comma separates list of tag IDs to filter",
            ),
            OpenApiParameter(
                "ingredients",
                OpenApiTypes.STR,
                description="Comma separates list of ingredient IDs to filter",
            ),
        ]
    )
)
    ...
    list=extend_schema(
        parameters=[
            OpenApiParameter(
                ...
                OpenApiTypes.INT,
                enum=[0, 1],
                description="Retrieve only assigned items",
            )
        ]
    )
)
class BaseRecipeAttrViewSet(
    ...
    """Base viewset forrecipe attributes"""
